...
const faqItems = [
  {
    q: "Tôi sẽ nhận được phản hồi nhanh chóng như thế nào?",
    a: "Người dùng gói Free: trong 2–3 ngày làm việc. Người dùng Premium: trong 24 giờ. Người dùng Family: trong 4 giờ qua kênh hỗ trợ chuyên dụng.",
  },
  {
    q: "Có hỗ trợ trò chuyện trực tiếp hoặc qua điện thoại không?",
    a: "Gói Family bao gồm kênh Slack chuyên dụng với nhóm DeepGuard. Hỗ trợ điện thoại có sẵn cho khách hàng Family SLA.",
  },
  {
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 pt-32 pb-24">
        ...
        >
          ...
          >
            Have a question, need enterprise pricing, or want to report an
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-16">
          {contactOptions.map(
            ({ icon: Icon, title, desc, email, color }, i) => (
              <motion.a
                key={title}
                href={`mailto:${email}`}
              ...
              >
                ...
                <span
                  className="text-[#2563EB] dark:text-[#22D3EE] group-hover:underline"
                  style={{ fontSize: "12px", fontWeight: 600 }}
                >
                  {email}
                </span>
          ...
          >
            ...
            <div className="rounded-2xl bg-gradient-to-br from-[#2563EB] to-blue-800 p-6 text-white">
              ...
              <div className="space-y-3">
                {[
                  { plan: "Free", time: "2–3 ngày làm việc", icon: "🌱" },
                  { plan: "Premium", time: "Trong vòng 24 giờ", icon: "⚡" },
                  {
                    plan: "Family",
                    time: "Trong vòng 4 giờ (SLA)",
                    icon: "🏢",
                  },
                ].map(({ plan, time, icon }) => (
                  <div
                ...
                {[
                  {
                    ...
                    icon: "📖",
                    desc: "API docs and integration guides",
                  },
                  {
                    label: "System Status",
                    icon: "🟢",
                  ...
                  },
                  {
                    ...
                    icon: "💻",
                    desc: "Open source tools and SDKs",
                  },
                  {
                  ...
                  >
                    ...
                    <div>
                      <p
                        className="text-slate-900 dark:text-slate-200 group-hover:text-[#2563EB] dark:group-hover:text-[#22D3EE] transition-colors"
                        style={{ fontSize: "13px", fontWeight: 600 }}
                      >
                        {label}
                      </p>
                ...
                {faqItems.map(({ q, a }, i) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <span
                        className={`flex-shrink-0 w-5 h-5 rounded-full flex items-center justify-center transition-all ${openFaq === i ? "bg-[#2563EB] text-white rotate-45" : "bg-slate-100 dark:bg-slate-700 text-slate-500"}`}
                        style={{ fontSize: "16px" }}
                      >
                        +
                      </span>
