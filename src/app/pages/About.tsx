...
const milestones = [
  { year: '2021', title: 'Founded', desc: 'DeepGuard AI started as a research project at MIT, targeting synthetic media threats.' },
  { year: '2022', title: 'Seed Round', desc: 'Raised $4M seed. First enterprise pilot with a major news network.' },
  { year: '2023', title: 'Series A', desc: '$18M Series A led by Sequoia. Launched the public SaaS platform with 5,000+ users.' },
  { year: '2024', title: 'Global Expansion', desc: 'Expanded to 150+ countries. Reached 1M scans milestone. SOC 2 Type II certified.' },
  { year: '2025', title: 'V2 Platform', desc: 'Launched multi-modal AI engine v2.0 with 98.7% accuracy across image, video, and audio.' },
  { year: '2026', title: 'Today', desc: '50,000+ professionals trust DeepGuard AI. Processing 100,000+ scans per day.' },
];

const values = [
  { icon: Lock, title: 'Privacy First', desc: 'We process your files in isolated sandboxes and delete them immediately after analysis. No data is ever sold or shared.', color: '#22D3EE' },
  { icon: Brain, title: 'AI Transparency', desc: 'Every verdict comes with a detailed explanation of why the AI flagged it — no black boxes, no unexplained decisions.', color: '#2563EB' },
  { icon: Globe, title: 'Open Research', desc: 'We publish our research, benchmark datasets, and model improvements to advance the entire field of deepfake detection.', color: '#8B5CF6' },
  { icon: Users, title: 'Accessibility', desc: 'Deepfake detection should not be gatekept. Our free tier ensures students, journalists, and NGOs have access.', color: '#10B981' },
];
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#0F172A]" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        <div
          ...
          style={{ backgroundImage: 'radial-gradient(circle, rgba(37,99,235,0.12) 1px, transparent 1px)', backgroundSize: '32px 32px' }}
        />
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          ...
          <motion.h1
            ...
            style={{ fontSize: 'clamp(32px, 5vw, 52px)', fontWeight: 800, lineHeight: 1.1, letterSpacing: '-1.5px' }}
          >
          ...
          >
            DeepGuard AI was built by researchers and engineers who believe that synthetic media detection should be
            accessible to everyone — not just well-funded organizations. Our mission is to restore trust in digital content.
          </motion.p>
        </div>
      </section>
      ...
      <section className="border-y border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0F172A]">
        <div className="max-w-7xl mx-auto px-6 py-10 grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            ...
            >
              <div className="text-slate-900 dark:text-white" style={{ fontSize: '32px', fontWeight: 800, letterSpacing: '-0.5px' }}>{value}</div>
              <div className="text-slate-500 dark:text-slate-500 mt-1" style={{ fontSize: '13px', fontWeight: 500 }}>{label}</div>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-50 dark:bg-[#0F172A]">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <span className="inline-block px-3 py-1 rounded-full bg-[#2563EB]/10 text-[#2563EB] dark:text-[#22D3EE] mb-4" style={{ fontSize: '12px', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase' }}>Our Values</span>
            <h2 className="text-slate-900 dark:text-white" style={{ fontSize: '36px', fontWeight: 800, letterSpacing: '-0.8px' }}>What We Stand For</h2>
          </motion.div>
          <div className="grid md:grid-cols-2 gap-6">
            {values.map(({ icon: Icon, title, desc, color }, i) => (
              ...
              >
                ...
                <h3 className="text-slate-900 dark:text-white mb-2" style={{ fontSize: '17px', fontWeight: 700 }}>{title}</h3>
      ...
      <section className="py-24 bg-white dark:bg-[#0C1220]">
        <div className="max-w-4xl mx-auto px-6">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <span className="inline-block px-3 py-1 rounded-full bg-[#2563EB]/10 text-[#2563EB] dark:text-[#22D3EE] mb-4" style={{ fontSize: '12px', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase' }}>History</span>
            <h2 className="text-slate-900 dark:text-white" style={{ fontSize: '36px', fontWeight: 800, letterSpacing: '-0.8px' }}>Our Journey</h2>
          </motion.div>
                ...
                >
                  ...
                  <div className="flex-1 pb-8">
                    <div className="flex items-center gap-3 mb-2">
                      <span className="px-2.5 py-1 rounded-lg bg-[#2563EB]/10 text-[#2563EB] dark:text-[#22D3EE]" style={{ fontSize: '12px', fontWeight: 700 }}>{year}</span>
                      <span className="text-slate-900 dark:text-white" style={{ fontSize: '16px', fontWeight: 700 }}>{title}</span>
                    </div>
                    <p className="text-slate-500 dark:text-slate-400" style={{ fontSize: '14px', lineHeight: 1.7 }}>{desc}</p>
                  </div>
                </motion.div>
      ...
      <section className="py-24 bg-slate-50 dark:bg-[#0F172A]">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <span className="inline-block px-3 py-1 rounded-full bg-[#2563EB]/10 text-[#2563EB] dark:text-[#22D3EE] mb-4" style={{ fontSize: '12px', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase' }}>Leadership</span>
            <h2 className="text-slate-900 dark:text-white mb-4" style={{ fontSize: '36px', fontWeight: 800, letterSpacing: '-0.8px' }}>The Team Behind DeepGuard</h2>
            <p className="text-slate-500 dark:text-slate-400 max-w-xl mx-auto" style={{ fontSize: '16px', lineHeight: 1.7 }}>
              World-class researchers, engineers, and security experts united by one mission.
            </p>
          </motion.div>
            ...
            {team.map(({ name, role, bio, avatar, gradient }, i) => (
              ...
              >
                <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${gradient} flex items-center justify-center mx-auto mb-4`}>
                  <span className="text-white" style={{ fontSize: '20px', fontWeight: 800 }}>{avatar}</span>
                </div>
                <h3 className="text-slate-900 dark:text-white mb-1" style={{ fontSize: '15px', fontWeight: 700 }}>{name}</h3>
                <p className="text-[#2563EB] dark:text-[#22D3EE] mb-3" style={{ fontSize: '12px', fontWeight: 600 }}>{role}</p>
                <p className="text-slate-500 dark:text-slate-400" style={{ fontSize: '13px', lineHeight: 1.65 }}>{bio}</p>
                <div className="flex items-center justify-center gap-3 mt-4">
                  <a href="#" className="text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 transition-colors"><Linkedin className="w-4 h-4" /></a>
                  <a href="#" className="text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 transition-colors"><Twitter className="w-4 h-4" /></a>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      <section className="py-20 bg-white dark:bg-[#0C1220]">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
            <span className="inline-block px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 mb-4" style={{ fontSize: '12px', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase' }}>Trusted By</span>
            <h2 className="text-slate-900 dark:text-white" style={{ fontSize: '28px', fontWeight: 800, letterSpacing: '-0.5px' }}>Partners & Integrations</h2>
          </motion.div>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {partners.map(({ name, type }, i) => (
              ...
              >
                ...
                <p className="text-slate-900 dark:text-white" style={{ fontSize: '12px', fontWeight: 700 }}>{name}</p>
                <p className="text-slate-400" style={{ fontSize: '10px' }}>{type}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-[#2563EB] relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-6 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-white mb-4" style={{ fontSize: '32px', fontWeight: 800, letterSpacing: '-0.8px' }}>Join Our Mission</h2>
            <p className="text-blue-100 mb-8" style={{ fontSize: '16px', lineHeight: 1.7 }}>
              Start protecting yourself and your organization from synthetic media threats today.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              <a href="mailto:contact@deepguard.ai" className="flex items-center gap-2 px-7 py-3.5 rounded-xl border border-white/30 text-white hover:bg-white/10 transition-all" style={{ fontSize: '15px', fontWeight: 600 }}>
                Contact Us
              </a>
            </div>
          </motion.div>
